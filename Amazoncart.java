...
public class Amazoncart {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='ap_email']")).sendKeys("pranjalibhore2000@gmail.com");
		act.moveToElement(driver.findElement(By.xpath("//input[@id='continue']")));
		act.click().build().perform();

		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Pranju@20");
		driver.findElement(By.xpath("//input[@id='signInSubmit']")).click();

		driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']")).clear();
		driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']")).sendKeys("air conditioner");
